...
| Имя      | Возраст | Логин                          |
|----------|---------|--------------------------------|
| Анна     | 15      | `@anna_p` / +79215550101       |
| Максим   | 33      | `@max_w` / +79215550102        |
| Лена     | 13      | `@lena_s` / +79215550103       |
| Игорь    | 37      | `@igor_d` / +79215550104       |
| Катя     | 16      | `@kate_i` / +79215550105       |
| Дмитрий  | 31      | `@dmitry_n` / +79215550106     |
| Stack    | ✓       | `@stack_help` (верифицирован)  |

Чтобы увидеть **защиту в действии**: войдите как Анна, попробуйте создать чат с Максимом — сервер ответит `AGE_RESTRICTED`.
